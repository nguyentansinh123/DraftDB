...
import { components, createButtonClass, createNavLinkClass } from "../styles/components";
...
const navLinks = [
  ...
  { label: "Templates", href: "#templates", icon: <Database className="w-4 h-4" /> },
];
          ...
          <div className={components.container.mobileMenu}>
            <div className="flex flex-col gap-2">
              ...
              <a
                href="#editor"
                onClick={() => setMenuOpen(false)}
                className={clsx(createButtonClass('primary'), "mt-3 justify-center")}
              >
                <Database className="w-4 h-4" />
                Launch Editor
              </a>
